...
Na GitHub Pages proxy nie je — klik na **Výpis** otvorí Kataster v samostatnom okne (`GeneratePrfPublic`) a skopíruje k.ú. + LV do schránky. **ZBGIS mapa** otvorí MAPKA na parcele z `lv_parcels`, inak na strede k.ú.
